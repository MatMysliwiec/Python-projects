...
numery = ["Dwa", "Trzy", "Cztery", "Piec", "Szesc", "Siedem", "Osiem", "Dziewiec", "Dziesiec", "Walet", "Dama", "Krol",
          "As"]
wartosci = {"Dwa": 2, "Trzy": 3, "Cztery": 4, "Piec": 5, "Szesc": 6, "Siedem": 7, "Osiem": 8, "Dziewiec": 9,
            "Dziesiec": 10, "Walet": 11, "Dama": 12, "Krol": 13, "As": 14}
...
if __name__ == "__main__":
    ...
    print(
        "Zasady: Pierwszy i drugi zawodnik równocześnie wykładają po jednej karcie i porównują ich wartości (względem "
        "starszeństwa – kolory nie odgrywają roli).")
    print(
        "Gracz mający kartę o wyższej wartości odbiera karty i kładzie je pod spodem swojej talii. Jeśli karty mają "
        "taką samą siłę (as na asa, król na króla, itp.), rozpętuje się wojna")
    print(
        "Wyciągane są pięc kart. Ostatnia wyciągnieta karta o wyższej wartości wygrywa, a zwycięzca wojny odbiera "
        "wszystkie karty wykorzystane w wojnie. Proces jest powtarzany, jeśli w okresie wojny znowu nie można wyłonić "
        "zwycięzcy. ")
    ...
    while game_on:
        ...
        gracz_1_karty = [gracz_1.wykladanie_karty()]
        gracz_2_karty = [gracz_2.wykladanie_karty()]
